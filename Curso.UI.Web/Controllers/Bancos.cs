...
{
    public class Bancos : Controller
    {
...
//</script>
    ...
    //                    <div id = "title-principal" class="col-md-12">
    //                        <h4>@ViewData["NomePagina"]</h4>
    //                    </div>
    //                </div>
    ...
    //<footer class="footer navbar-fixed-bottom border-top text-muted">
    //    <p>&copy; 2020 - Controle de Fluxo de Caixa 3CON</p>
    //</footer>
